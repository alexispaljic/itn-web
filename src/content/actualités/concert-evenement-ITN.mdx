...
Autour d’un cocktail et de démonstrations d’espaces métavers, l’équipe de l’Institut des Transformations Numériques vous invite à découvrir des projets de recherche et échanger sur les applications potentielles des technologies numériques dans vos activités.

A 20h, pour ceux qui le souhaitent, la soirée se poursuivra par une expérience artistique, numérique et immersive inédite autour des œuvres de Frédéric Chopin et Pierre Wissmer. 
