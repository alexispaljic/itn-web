...
<ul class="ml-[10px]">
  <ListItem icon="hand-finger">**Interactions**</ListItem>
  <ListItem icon="users-group">**Collaboration**</ListItem>
  <ListItem icon="accessible">**Accessibilité**</ListItem>
  <ListItem icon="code">**Programmation**</ListItem>
  <ListItem icon="device-gamepad-2">**Conception de jeu**</ListItem>
  <ListItem icon="frustum">**Modélisation 3D**</ListItem>
  <ListItem icon="augmented-reality">**Réalité augmentée**</ListItem>
  <ListItem icon="badge-vr">**Réalité virtuelle**</ListItem>
  <ListItem icon="stereo-glasses">**Photogrammétrie**</ListItem>
  <ListItem icon="currency-euro">**Modèles économiques**</ListItem>
</ul>
