...
<div>
  <div class="w-[240px] sm:ml-4 sm:w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4">
...
- Title (/subtitle?)
- Tags (icons/text ?) Icons + tooltip?
- Texte (?) None/short/short+long?
- Client
- Team
- -> Learn more
...
- Interaction 3D
- Casques de VR, Interaction en Groupe, Visite du Chateau
- Interactions, Participation, Métavers, Concert
- Accessibilité
