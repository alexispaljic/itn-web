---
title: Projets
description: La stratégie de l'ITN en action
...
<div>
  <nav class="block m-auto w-[21ch] md:w-full flex flex-col justify-center md:flex-row gap-4">
    ...
    <Tag color="purple" icon="tabler:palette" tag="Industries créatives" />
    <Tag color="red" icon="tabler:vaccine" tag="Santé numérique" />
  </nav>
</div>
...
<ListItem color="red" icon="tabler:vaccine">
...
<ListItem color="purple" icon="tabler:palette">
