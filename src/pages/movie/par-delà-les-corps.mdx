...
Le projet « Par-delà les corps » (titre provisoire) s’inscrit dans la continuité
de mes recherches artistiques et répond à la commande photographique nationale
[PERFORMANCE] du [Centre National de Arts Plastiques][CNAP],
dans le contexte des Jeux Olympiques 2024 à venir.
Cette commande aboutira à plusieurs expositions, dont le
[Musée régional d’art contemporain][MRAC]
(printemps-été 2024), le [Centre Photographique Marseille][CPM] (automne 2024),
ainsi que d’autres contextes d’espaces publics à Paris et ailleurs.
